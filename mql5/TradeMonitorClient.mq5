...
input string   InpUserKey = "YOUR_API_KEY_HERE"; // User API-Key (from Admin Dashboard)
...
void InitConfig()
{
   if(LoadConfig())
   {
      ...
      if(InpUserKey != "" && InpUserKey != "YOUR_API_KEY_HERE" && InpUserKey != cfg_UserKey) uiChanged = true;
      ...
      if(uiChanged)
      {
         ...
         cfg_UserKey = (InpUserKey != "" && InpUserKey != "YOUR_API_KEY_HERE") ? InpUserKey : cfg_UserKey;
