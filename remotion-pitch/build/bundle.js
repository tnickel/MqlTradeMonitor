...
const BootSequence = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "20px" }, children: [
        visibleLines.map((line, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              color: "#3fb950",
        ...
        Math.floor(frame / 15) % 2 === 0 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              color: "#3fb950",
...
const StatsCounter = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const accountsCount = Math.round((0,esm.spring)({ frame, fps, config: { damping: 200 }, durationInFrames: 60 }) * 42);
  const tradesCount = Math.round((0,esm.spring)({ frame: frame - 15, fps, config: { damping: 200 }, durationInFrames: 60 }) * 345);
  const latency = Math.max(4, Math.round(100 - (0,esm.spring)({ frame: frame - 30, fps, config: { damping: 200 }, durationInFrames: 60 }) * 96));
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "row", gap: "100px", textAlign: "center" }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { opacity: frame > 0 ? 1 : 0 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "120px", fontWeight: "bold", color: "#58a6ff" }, children: accountsCount }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "30px", color: "#8b949e", textTransform: "uppercase", letterSpacing: "2px" }, children: "Connected Terminals" })
          ] }),
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { opacity: frame > 15 ? 1 : 0 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "120px", fontWeight: "bold", color: "#a371f7" }, children: tradesCount }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "30px", color: "#8b949e", textTransform: "uppercase", letterSpacing: "2px" }, children: "Active Trades" })
          ] }),
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { opacity: frame > 30 ? 1 : 0 }, children: [
            /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { fontSize: "120px", fontWeight: "bold", color: latency <= 10 ? "#3fb950" : "#f85149" }, children: [
              latency,
              "ms"
            ] }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "30px", color: "#8b949e", textTransform: "uppercase", letterSpacing: "2px" }, children: "Network Latency" })
          ] })
        ] }),
        ...
        }, children: "ASYNC WORKER THREADS: RUNNING" })
      ]
    }
  );
};

;// ./src/SecurityAlert.tsx
...
const SecurityAlert = () => {
  ...
  const bannedCount = Math.round((0,esm.spring)({ frame: frame - 100, fps, config: { damping: 200 }, durationInFrames: 60 }) * 9);
  const scale = (0,esm.interpolate)((0,esm.spring)({ frame: frame - 10, fps, config: { damping: 12 } }), [0, 1], [0.8, 1]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "40px", transform: `scale(${scale})` }, children: [
        showWarning && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "60px", fontWeight: "bold", color: "#f85149", letterSpacing: "4px" }, children: "[!] WARNING: UNAUTHORIZED SSH ACCESS DETECTED" }),
        showDefense && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "50px", fontWeight: "bold", color: "#58a6ff" }, children: "OS-LEVEL DEFENSE: FAIL2BAN INTEGRATION ACTIVE" }),
        showCounter && /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", marginTop: "40px" }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "160px", fontWeight: "bold", color: "#f85149" }, children: bannedCount }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: "40px", color: "#8b949e", textTransform: "uppercase", letterSpacing: "3px" }, children: "ATTACKER IPs BANNED" })
        ] })
      ] })
    }
  );
...
const FadeText = ({ text, delay }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const opacity = (0,esm.interpolate)(frame - delay, [0, 15], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  const translateY = (0,esm.interpolate)((0,esm.spring)({ frame: frame - delay, fps, config: { damping: 14 } }), [0, 1], [50, 0]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity, transform: `translateY(${translateY}px)`, fontSize: "70px", fontWeight: 900, color: "white", letterSpacing: "5px", marginBottom: "20px" }, children: text });
};
const TypographyFinale = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const finalOpacity = (0,esm.interpolate)(frame, [400, 430], [1, 0], { extrapolateLeft: "clamp", extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", alignItems: "center" }, children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeText, { text: "ZERO LATENCY.", delay: 10 }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeText, { text: "MILITARY GRADE SECURITY.", delay: 50 }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(FadeText, { text: "FULL-STACK ENGINEERING.", delay: 90 }),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
          marginTop: "100px",
          opacity: (0,esm.interpolate)(frame - 150, [0, 30], [0, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" }),
          fontSize: "40px",
          color: "#8b949e",
          letterSpacing: "2px"
        }, children: [
          "MQL Trade Monitor. Engineered by ",
          /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: "white", fontWeight: "bold" }, children: "Thomas Nickel" }),
          "."
        ] })
      ] })
    }
...
const MyComposition = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "black" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 300, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BootSequence, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 300, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(StatsCounter, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 750, durationInFrames: 600, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SecurityAlert, {}) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 1350, durationInFrames: 450, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(TypographyFinale, {}) })
  ] });
};
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(213), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 3213)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "remotion-pitch:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkremotion_pitch"] = self["webpackChunkremotion_pitch"] || [];
